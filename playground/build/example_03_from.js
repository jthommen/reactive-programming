'use strict';var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) {return typeof obj;} : function (obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};var _Rx = require('rxjs/Rx');var _Rx2 = _interopRequireDefault(_Rx);
...
.mergeMap(function (files) {return _Rx2.default.Observable.from(files);}) // Convert array into observable with next calls
.map(function (file) {return 'MANIPULATED ' + file;}).
...
_Rx2.default.Observable.fromPromise(getItem()).
